<template>
  <div class="p-2">
        ...
        <a-row :gutter="24">
          <a-col :lg="8">
            <a-form-item label="科目名称">
              <a-input placeholder="请输入科目名称" v-model:value="queryParam.name" />
            </a-form-item>
          </a-col>
          <a-col :lg="8">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
              <a-col :lg="6">
                ...
                <a @click="toggleSearchStatus = !toggleSearchStatus" style="margin-left: 8px" v-if="false">
    ...
    <!-- 表单区域 -->
    <SubjectModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
