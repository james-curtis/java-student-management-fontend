        ...
        <a-row :gutter="24">
          <a-col :lg="8">
            <a-form-item label="学生">
              <j-select-user-by-dept placeholder="请选择学生" v-model:value="queryParam.studentId" :multiple="false" />
            </a-form-item>
          </a-col>
          <a-col :lg="8">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :lg="8">
              <a-form-item label="成绩">
                <a-input placeholder="请输入最小值" v-model:value="queryParam.score_begin" class="query-group-cust" />
                <span class="query-group-split-cust">~</span>
                <a-input placeholder="请输入最大值" v-model:value="queryParam.score_end" class="query-group-cust" />
              </a-form-item>
            </a-col>
          </template>
...
<script lang="ts" name="stu-score" setup>
